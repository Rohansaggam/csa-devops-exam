CSA-DevOps-Exam: Jenkins + Terraform AWS Automation
Overview
...
Defines pipeline stages: Plan → Apply → Validate
...
git clone https://github.com/<your-org>/csa-devops-exam.git
cd csa-devops-exam
...
Internal / Educational / Enterprise-ready

✅ This version has:

Clear headings and spacing

Tables for architecture clarity

Bullet points for easy reading

Underlines implicitly via section headings
